...
export function PdfCompressor({ chain, ui, common, errors }: { chain: ChainCopy; ui: Ui; common: Common; errors: Errors }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {result && compressed && (
        <SendTo chain={chain} from="pdf-compress" files={[{ url: result.url, name: result.name }]} />
      )}
    </div>
  );
}
