...
export default async function VideoConvertPage({
  ...
  return (
    <article className="space-y-10">
      ...
      <VideoConverter ui={tool.ui} common={dict.common} errors={dict.mediaErrors} chain={chainCopy(locale, dict)} />
      ...
      <RelatedTools locale={locale} slug="video-convert" dict={dict} />
    </article>
  );
}
