...
export default async function PdfMergePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <article className="space-y-10">
      <JsonLd data={toolJsonLd(locale, dict, "pdf-merge")} />
      ...
      <PdfMerger ui={tool.ui} common={dict.common} errors={dict.pdfErrors} chain={chainCopy(locale, dict)} />
      ...
      <RelatedTools locale={locale} slug="pdf-merge" dict={dict} />
    </article>
  );
}
