...
export async function generateMetadata({
  ...
  const tool = getDictionary(locale).tools["data-query"];
  return {
...
export default async function VideoConvertPage({
  ...
  const tool = dict.tools["data-query"];
  ...
  return (
    <article className="space-y-10">
      ...
      <DataQuery ui={tool.ui} common={dict.common} />
      ...
      <RelatedTools locale={locale} slug="data-query" dict={dict} />
    </article>
  );
}
