...
export async function removeBackground(
  ...
  try {
    ...
    return {
       ...
       *
       * **실사진 24장 실측(2026-07-27).** 결과를 하나하나 눈으로 보고 라벨을 붙였다.
       *
       * | 사진 | 단호 | 비율 | 눈으로 본 결과 |
       * |---|---|---|---|
       ...
       * | 나비 | 50.9% | 9.22 | 좋음 |
       * | 손목시계 | 33.6% | 8.55 | 좋음 |
       * | 개 · 고양이 · 주전자 · 와인잔 | 18~34% | 5.7~6.1 | 좋음 |
       * | 체스 · 레서판다 · 인물 · 재규어 | 15~36% | 3.1~4.0 | 좋음 |
       * | 자전거 | 28.6% | 2.47 | 좋음(바퀴살까지 살아 있다) |
       * | 커피잔 | 10.3% | 0.65 | 좋음 |
       * | **후지산** | 3.9% | **0.395** | 좋음 ← 좋은 것의 최저 |
       * | **교통정체** | 6.2% | **0.198** | **반투명 유령 차** ← 나쁜 것의 최고 |
       * | 비둘기 도판 14마리 | 3.1% | 0.130 | **유령 7마리** |
       * | 군중 · 타임스스퀘어 | 0.3% | 0.02~0.07 | **반투명 얼룩** |
       * | 튤립밭 · 산호초 · 책장 | 0.0~0.1% | 0.007~0.009 | **거의 아무것도 없음** |
       * | 열대우림 · 숲 · 은하수 | 0.0% | 0.000 | **아무것도 없음** |
       *
       * 좋은 것과 나쁜 것 사이가 **2배뿐이다**(0.395 ↔ 0.198). 그 기하 중간인 0.28 을
       * 쓴다 — 양쪽 여유가 1.41배로 같아진다. 표본이 더 늘면 다시 잴 것.
       */
