...
export const en = {
  ...
  lab: {
    metaTitle: "Lab — heavy experiments that run in your browser",
    metaDescription: "Tools too large for everyday use, kept here on purpose. Each one tells you the download size before it starts. Nothing is uploaded.",
    h1: "Lab",
    lead: "Things too heavy to put on the front page — but real, and yours to run if your connection and machine can take them.",
    breadcrumb: "Lab",
    warningHeading: "This one is big",
    warningBody: "Everything still happens inside this tab, but the model has to reach your browser first. Use Wi-Fi. Mobile data will hurt.",
    downloadLabel: "Download",
    onceLabel: "Downloaded once, then kept by your browser",
    startLabel: "I understand — continue",
    needsWebgpu: "This needs WebGPU. Try a desktop browser (Chrome or Edge).",
    entries: {
      pii: {
        metaTitle: "Find Personal Information in a Document",
        metaDescription: "Point a model at a contract or an export and see every name, address and number it finds. Runs in your browser; nothing is uploaded.",
        h1: "Find personal information in a document",
        blurb: "Spots names, addresses and numbers in a document and can black them out.",
        lead: "Before you send a contract, an export or a log to someone, see what personal data is actually in it.",
        pickLabel: "Choose a document",
        scanLabel: "Find personal information",
        scanningLabel: "Reading the document…",
        maskLabel: "Black out what was found",
        downloadLabel: "Download the redacted text",
        emptyFound: "Nothing that looks personal was found.",
        foundHeading: "Found",
        kinds: {
            name: "names",
            address: "addresses",
        ...
        caveat: "It guesses from context, so it misses things and it flags things that are fine. Read the result — do not treat it as a clean bill of health.",
        errors: {
          UNSUPPORTED_INPUT: "That file type cannot be opened here.",
          NO_TEXT: "No text layer was found. If this is a scan, run it through OCR first.",
          TOO_SHORT: "Too short to be worth this download — read it yourself.",
          TOO_LONG: "Too long for one pass. Split it and run the parts separately.",
          NO_WEBGPU: "This needs WebGPU. Try a desktop browser (Chrome or Edge).",
          ENGINE_FAILED: "The engine could not be loaded. Check your connection.",
          MODEL_FAILED: "The model could not be loaded.",
        },
      },
    },
  },
  ...
  home: {
    ...
    searchPlaceholder: "Search — HEIC, PDF, subtitles…",
    searchEmpty: "No tool matches that. Try a file format, like HEIC or MP4.",
