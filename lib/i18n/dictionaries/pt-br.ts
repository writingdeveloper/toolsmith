...
export const ptBR = {
  ...
  lab: {
    metaTitle: "Laboratório — experimentos pesados no navegador",
    metaDescription: "Ferramentas grandes demais para o dia a dia, colocadas aqui de propósito. Cada uma avisa o tamanho do download antes de começar. Nada é enviado.",
    h1: "Laboratório",
    lead: "Coisas pesadas demais para a página inicial — mas reais, e suas para usar se a conexão e a máquina derem conta.",
    breadcrumb: "Laboratório",
    warningHeading: "Esta é grande",
    warningBody: "Tudo continua acontecendo dentro desta aba, mas o modelo precisa chegar ao seu navegador antes. Use Wi-Fi: no dado móvel dói.",
    downloadLabel: "Download",
    onceLabel: "Baixado uma vez e guardado pelo navegador",
    startLabel: "Entendi — continuar",
    needsWebgpu: "Isto precisa de WebGPU. Tente um navegador de desktop (Chrome ou Edge).",
    entries: {
      pii: {
        metaTitle: "Encontrar dados pessoais em um documento",
        metaDescription: "Aponte um modelo para um contrato ou exportação e veja cada nome, endereço e número encontrado. No navegador, sem enviar nada.",
        h1: "Encontrar dados pessoais em um documento",
        blurb: "Encontra nomes, endereços e números em um documento e pode tapá-los.",
        lead: "Antes de mandar um contrato, uma exportação ou um registro para alguém, veja quais dados pessoais existem ali de verdade.",
        pickLabel: "Escolher um documento",
        scanLabel: "Procurar dados pessoais",
        scanningLabel: "Lendo o documento…",
        maskLabel: "Tapar o que foi encontrado",
        downloadLabel: "Baixar o texto tapado",
        emptyFound: "Nada que pareça pessoal foi encontrado.",
        ...
        kinds: {
            ...
            date: "datas",
            url: "links",
            account: "números de conta",
            secret: "segredos",
            other: "outros",
          },
        caveat: "Ele adivinha pelo contexto, então deixa coisas passarem e marca outras que estão bem. Leia o resultado — não trate como atestado de que está limpo.",
        errors: {
          UNSUPPORTED_INPUT: "Esse tipo de arquivo não abre aqui.",
          NO_TEXT: "Não há camada de texto. Se for digitalização, passe primeiro pelo OCR.",
          TOO_SHORT: "Curto demais para justificar um download desse tamanho — leia você mesmo.",
          TOO_LONG: "Longo demais para uma passada. Divida e rode em partes.",
          NO_WEBGPU: "Isto precisa de WebGPU. Tente um navegador de desktop (Chrome ou Edge).",
          ENGINE_FAILED: "Não foi possível carregar o motor. Verifique sua conexão.",
          MODEL_FAILED: "Não foi possível carregar o modelo.",
        },
      },
    },
  },
