...
export const de = {
  ...
  lab: {
    metaTitle: "Labor — schwere Experimente im Browser",
    metaDescription: "Werkzeuge, die für den Alltag zu groß sind, stehen hier mit Absicht. Jedes nennt die Downloadgröße, bevor es startet. Nichts wird hochgeladen.",
    h1: "Labor",
    lead: "Dinge, die für die Startseite zu schwer sind — aber echt, und für Sie nutzbar, wenn Leitung und Rechner das tragen.",
    breadcrumb: "Labor",
    warningHeading: "Dieses hier ist groß",
    warningBody: "Alles passiert weiterhin in diesem Tab, aber das Modell muss erst zu Ihrem Browser gelangen. Nutzen Sie WLAN — über Mobilfunk tut das weh.",
    downloadLabel: "Download",
    onceLabel: "Einmal geladen, danach vom Browser aufbewahrt",
    startLabel: "Verstanden — weiter",
    needsWebgpu: "Dafür wird WebGPU benötigt. Versuchen Sie einen Desktop-Browser (Chrome oder Edge).",
    entries: {
      pii: {
        metaTitle: "Persönliche Daten im Dokument finden",
        metaDescription: "Lassen Sie ein Modell über einen Vertrag oder Export laufen und sehen Sie jeden Namen, jede Adresse, jede Nummer. Im Browser, ohne Upload.",
        h1: "Persönliche Daten in einem Dokument finden",
        blurb: "Erkennt Namen, Adressen und Nummern in einem Dokument und kann sie schwärzen.",
        lead: "Bevor Sie einen Vertrag, einen Export oder ein Protokoll weitergeben: sehen Sie nach, welche persönlichen Daten wirklich darin stehen.",
        pickLabel: "Dokument wählen",
        scanLabel: "Persönliche Daten finden",
        scanningLabel: "Dokument wird gelesen…",
        maskLabel: "Gefundenes schwärzen",
        downloadLabel: "Geschwärzten Text herunterladen",
        emptyFound: "Es wurde nichts gefunden, das persönlich aussieht.",
        foundHeading: "Gefunden",
        kinds: {
            name: "Namen",
            address: "Adressen",
            ...
            date: "Datumsangaben",
            url: "Links",
            account: "Kontonummern",
            secret: "Geheimnisse",
            other: "Sonstiges",
          },
        caveat: "Es rät aus dem Zusammenhang, übersieht also manches und markiert Unbedenkliches. Lesen Sie das Ergebnis — es ist kein Freibrief.",
        errors: {
          UNSUPPORTED_INPUT: "Dieser Dateityp lässt sich hier nicht öffnen.",
          NO_TEXT: "Keine Textebene gefunden. Bei einem Scan zuerst durch die Texterkennung schicken.",
          TOO_SHORT: "Zu kurz für einen Download dieser Größe — lesen Sie es selbst.",
          TOO_LONG: "Zu lang für einen Durchgang. Teilen Sie es auf.",
          NO_WEBGPU: "Dafür wird WebGPU benötigt. Versuchen Sie einen Desktop-Browser (Chrome oder Edge).",
          ENGINE_FAILED: "Die Engine konnte nicht geladen werden. Prüfen Sie Ihre Verbindung.",
          MODEL_FAILED: "Das Modell konnte nicht geladen werden.",
        },
      },
    },
  },
