...
**실물 파일 쓸이에서 지금까지 10건이 나왔다** — 자막 번역 4, PDF 계열 3(2026-07-26),
요약 3(2026-07-27). 전부 **스펙이 초록색인 채로** 살아 있었다. 픽스처는 우리가 만들기
...
**표본은 인터넷에서 실제로 받는다.** 이번에는 arXiv 논문 PDF, GitHub README,
위키백과 HTML, 구텐베르크 전문을 썼다.
