...
**실물 파일 쓸이에서 지금까지 12건이 나왔다** — 자막 번역 4, PDF 계열 3(2026-07-26),
요약 3, OCR 1 · 이미지 압축 1(2026-07-27). 전부 **스펙이 초록색인 채로** 살아 있었다. 픽스처는 우리가 만들기
...
변환·압축·크기조절, OCR, CSV 쿼리, 영상 변환·압축·자르기·GIF, 오디오 추출.
**아직 안 한 것**: 배경 제거·업스케일·컷아웃·스템 분리.
